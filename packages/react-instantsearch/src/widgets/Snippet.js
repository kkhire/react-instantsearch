 ...
 * @propType {function} [renderSeparator=',<space>'] - symbol used to separate the elements of the array in case the attributeName points to an array of strings. Default value `() => ',<space>'`
